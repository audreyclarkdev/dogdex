  ...
  return (
    <div className="page">
      ...
      <div className="home-buttons">
        <Link to="/breeds" className="home-btn">Browse Breeds</Link>
        {/* placeholder route until a dedicated "spot a dog" form exists */}
        <Link to="/sightings" className="home-btn">Spot Dog</Link>
        <Link to="/sightings" className="home-btn">My Collection</Link>
        <Link
      ...
      {breedOfDay
        ? (
          <div className="breed-of-day">
            {breedOfDay.image
              ? <img src={breedOfDay.image} alt={breedOfDay.name} className="dog-img" />
              : null}
